...
//        aboutViewController.modalPresentationStyle = UIModalPresentationFormSheet;
        ...
        [signInViewController setModalPresentationStyle:UIModalPresentationFormSheet];
...
//            [self presentModalViewController:aboutViewController animated:shouldAnimateTransition];
            [self presentModalViewController:signInViewController animated:shouldAnimateTransition];
        });
    }
}
