...
function clickHandler()
{
    ...
    {
        arel.Scene.setTrackingConfiguration("Assets3/TrackingData_Marker.xml");
        arel.Scene.getObject("1").setScale(new arel.Vector3D(2.0,2.0,2.0));
    }
    if (document.getElementById('radio2').checked)
    {
        arel.Scene.setTrackingConfiguration("Assets3/TrackingData_PictureMarker.xml");
        arel.Scene.getObject("1").setScale(new arel.Vector3D(8.0,8.0,8.0));
        
    }
    if (document.getElementById('radio3').checked)
    {
        arel.Scene.setTrackingConfiguration("Assets3/TrackingData_MarkerlessFast.xml");
